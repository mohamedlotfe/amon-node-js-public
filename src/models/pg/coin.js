...
module.exports = function (sequelize, DataTypes) {
  ...
  Coin.upsert = function (values, tOpts = {}) {
    // we can use upsert function instead of that
    return Coin.findOne(Object.assign({ where: { code: values.code } }, tOpts)).then(function (coinObj) {
      // update
      if (coinObj) return coinObj.update(values);
      // insert
